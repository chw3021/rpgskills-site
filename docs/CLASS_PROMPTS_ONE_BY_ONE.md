...
```
photorealistic, anime, chibi, slim proportions, wrong minecraft proportions, extra fingers, blurry, low quality, text, watermark, logo, multiple characters, cropped feet, white background, realistic skin
```

---

## 1/32 — swordman (먼저 이것만)
...
| 도구 | swordman 이후 일관성 |
|------|---------------------|
| **Midjourney** | 2번째부터 `--sref URL` 또는 동일 `--seed` + 짧은 variation |
| **DALL·E** | swordman 이미지를 reference로 업로드 (지원 시) |
