...
export const vanguardDetail: ClassDetailDef = {
  ...
  story: {
    ko: [
      ...
      '창 휘두르기는 재사용 대기시간 없이 1·2·3타를 순환하는 기본 공격입니다. 마지막으로 친 타수에 맞춰 다른 스킬이 강해지고, 그 강화된 스킬을 쓰면 잠시 받는 피해가 줄어듭니다.',
      ...
      skills: [
        ...
        },
        {
          ...
          ko: {
            ...
            input: '좌클릭',
            description:
              '재사용 대기시간이 없는 기본 공격입니다. 클릭할 때마다 1타·2타·3타가 순서대로 나가고, 3타 다음에는 다시 1타로 이어집니다. 1타는 짧게 전진하며 전방을 호로 베고, 2타는 어퍼컷으로 적을 띄우며 잠시 붙잡으며, 3타는 내려찍기와 충격파로 마무리합니다. 피해는 창 휘두르기 스킬 레벨에 비례합니다. 마지막으로 친 타수에 맞춰 다른 스킬이 강화되며(강화 시 피해량 7% 증가), 아직 한 번도 치지 않았다면 3타를 친 상태로 취급합니다. 로그아웃하거나 서버가 재시작되면 다시 처음부터입니다.',
          },
          en: {
            name: 'Spear Sweep',
            input: 'Left-click',
