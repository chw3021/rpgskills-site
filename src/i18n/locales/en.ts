...
export const en: Translations = {
  ...
  community: {
    firebaseNotConfigured:
      'Firebase is not configured. Create a .env file with VITE_FIREBASE_* values and rebuild.',
    authLoading: 'Checking sign-in…',
    signInHint: 'Sign in with Google to post and comment.',
    ...
    free: {
      pageTitle: 'Free board',
      pageDescription: 'Chat about the plugin, your server, and gameplay.',
      newPost: 'New post',
      writePost: 'Write post',
      editPost: 'Edit post',
      empty: 'No posts yet.',
      noSearchResults: 'No posts match your search.',
      notFound: 'This post does not exist or was deleted.',
    ...
    qna: {
      pageTitle: 'Q&A',
      pageDescription: 'Ask about install, errors, and configuration.',
      newPost: 'Ask a question',
      writePost: 'Ask question',
      editPost: 'Edit question',
      empty: 'No questions yet.',
      noSearchResults: 'No questions match your search.',
      notFound: 'This question does not exist or was deleted.',
      searchPlaceholder: 'Search title or content',
      titlePlaceholder: 'Question title',
      bodyPlaceholder: 'Symptoms, versions, steps to reproduce…',
      ...
      addComment: 'Submit answer',
      deletePost: 'Delete question',
      deleteComment: 'Delete answer',
      solved: 'Solved',
      markSolved: 'Mark solved',
      markOpen: 'Mark open',
      solvedBadge: 'Solved',
